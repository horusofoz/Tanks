...
public class Shell : MonoBehaviour {
    ...
    // The amount of damage done if the explision is centred on a tank
    ...
    private void OnCollisionEnter(Collision other)
    {
        ...
        // Only the tanks will have rigidbody scripts
        if(targetRigidbody != null)
        {
            ...
            {
                // Calculate the amoun of damage the target should take based on it's distance from the shell.
    ...
    private float CalculateDamage(Vector3 targetPosition)
    {
        ...
        // Calcuate damage as this proportion of the maximum possible damage
